...
```python
light_attenuation_analysis(run, excel_path, no_hills=1, vertical_crop=1000, sigma=0.005, moving_anom = 'no', moving_abs = 'no', fixed_anom = 'no', fixed_abs = 'no', w_vel = 'no', u_vel = 'no'): 
```
